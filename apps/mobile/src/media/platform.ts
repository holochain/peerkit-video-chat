/**
 * React Native platform binding for the media controller.
 *
 ...
 * `react-native-webrtc` so the module still type-checks under the Node toolchain
 * (the native stack is absent off-device, e.g. under vitest).
 */
